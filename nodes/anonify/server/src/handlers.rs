    ...
    W: Watcher,
{
    ...
    Ok(HttpResponse::Ok().json(anonify_node_api::deploy::post::Response(contract_addr)))
}

pub async fn handle_join_group<D, S, W>(
    server: web::Data<Arc<Server<D, S, W>>>,
    req: web::Json<anonify_node_api::join_group::post::Request>,
) -> Result<HttpResponse>
where
    D: Deployer,
    S: Sender,
    W: Watcher,
{
    ...
    Ok(HttpResponse::Ok().json(anonify_node_api::join_group::post::Response(tx_hash)))
}

pub async fn handle_update_mrenclave<D, S, W>(
    server: web::Data<Arc<Server<D, S, W>>>,
    req: web::Json<anonify_node_api::update_mrenclave::post::Request>,
) -> Result<HttpResponse>
where
    D: Deployer,
    S: Sender,
    W: Watcher,
{
    ...
    Ok(HttpResponse::Ok().json(anonify_node_api::update_mrenclave::post::Response(tx_hash)))
}

pub async fn handle_send_command<D, S, W>(
    server: web::Data<Arc<Server<D, S, W>>>,
    req: web::Json<anonify_node_api::state::post::Request>,
) -> Result<HttpResponse>
where
    D: Deployer,
    S: Sender,
    W: Watcher,
{
    ...
    Ok(HttpResponse::Ok().json(anonify_node_api::state::post::Response(tx_hash)))
}
    ...
    W: Watcher,
{
    ...
    Ok(HttpResponse::Ok().json(anonify_node_api::key_rotation::post::Response(tx_hash)))
}

/// Fetch events from blockchain nodes manually, and then get the state data from enclave.
pub async fn handle_get_state<D, S, W>(
    server: web::Data<Arc<Server<D, S, W>>>,
    req: web::Json<anonify_node_api::state::get::Request>,
) -> Result<HttpResponse>
where
    D: Deployer,
    S: Sender,
    W: Watcher,
{
    ...
    Ok(HttpResponse::Ok().json(anonify_node_api::state::get::Response { state }))
}
    ...
    W: Watcher,
{
    ...
    Ok(HttpResponse::Ok().json(anonify_node_api::encrypting_key::get::Response(pub_key)))
}
...
pub async fn handle_set_contract_addr<D, S, W>(
    server: web::Data<Arc<Server<D, S, W>>>,
    req: web::Json<anonify_node_api::contract_addr::post::Request>,
) -> Result<HttpResponse>
where
    D: Deployer,
    S: Sender,
...
pub async fn handle_register_notification<D, S, W>(
    server: web::Data<Arc<Server<D, S, W>>>,
    req: web::Json<anonify_node_api::register_notification::post::Request>,
) -> Result<HttpResponse>
where
    D: Deployer,
    S: Sender,
...
pub async fn handle_register_report<D, S, W>(
    server: web::Data<Arc<Server<D, S, W>>>,
    req: web::Json<anonify_node_api::register_report::post::Request>,
) -> Result<HttpResponse>
where
    D: Deployer,
    S: Sender,
    W: Watcher,
{
    ...
    Ok(HttpResponse::Ok().json(anonify_node_api::register_report::post::Response(tx_hash)))
}
