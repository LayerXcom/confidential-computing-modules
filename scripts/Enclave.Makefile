...
.PHONY: bindgen
bindgen: $(ANONIFY_ENCLAVE_DIR)/Enclave_t.h
	# @cd $(ENCLAVE_DIR) && cargo build -p anonify-types
	bindgen $(ANONIFY_ENCLAVE_DIR)/Enclave_t.h $(BINDGEN_FLAGS) -- $(BINDGEN_CLANG_FLAGS) > $(BINDGEN_OUTPUT_FILE)
